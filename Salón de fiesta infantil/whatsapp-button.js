document.addEventListener('DOMContentLoaded', function() {
    ...
    whatsappButton.href = 'https://wa.me/59899123456'; // Número de WhatsApp de la empresa
    whatsappButton.target = '_blank';
    whatsappButton.rel = 'noopener noreferrer';
    whatsappButton.setAttribute('aria-label', 'Contactar por WhatsApp');
    
    // Crear el icono de WhatsApp usando SVG para mejor calidad
    whatsappButton.innerHTML = `
        ...
        <span class="tooltip">Escribinos</span>
    `;
